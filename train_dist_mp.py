...
def main(rank: int, world_size: int, args):
    ...
    # os.environ["MASTER_ADDR"] = "local_host"
    # os.environ["MASTER_PORT"] = "12345"
    torch.distributed.init_process_group(backend='gloo', rank=args.local_rank, world_size=world_size, timeout=datetime.timedelta(0, 3600))
    ...
    # BUG: self.mfgs is None for non-memory-based model 
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description='tgl distributed training job')
    ...
    print(f"spawn {world_size} processes...")
